...
export const buildApplicationPreparationDraft = async (
  ...
  const current: Record<string, unknown> = {
    ...
    'applicant.clientType': data.applicant.clientType?.toLowerCase(),
    ...
    'applicant.companyName': data.applicant.companyName,
    'applicant.email': data.applicant.email,
    'applicant.phone': data.applicant.phone,
    'applicant.addressLine1': data.applicant.address.addressLine1,
    'applicant.addressLine2': data.applicant.address.addressLine2,
    'applicant.townCity': data.applicant.address.townCity,
    'applicant.postcode': data.applicant.address.postcode,
    'applicant.country': data.applicant.address.country,
    'agent.practiceName': data.organisation.practiceName,
    'agent.firstName': data.organisation.agent.firstName,
    'agent.lastName': data.organisation.agent.lastName,
    'agent.email': data.organisation.agent.email,
    'agent.phone': data.organisation.agent.phone,
    'agent.addressLine1': data.organisation.agent.address.addressLine1,
    'agent.addressLine2': data.organisation.agent.address.addressLine2,
    'agent.townCity': data.organisation.agent.address.townCity,
    'agent.postcode': data.organisation.agent.address.postcode,
    'agent.country': data.organisation.agent.address.country,
